...
outputbase = f"{mult}_{geom}_TZ_{nelecas}e_{ncas}o_eps1={eps1}"
...
# fmt: off
# uhf_chkfile = f"../../../uhf_survey_tz/NEWTON/{mult}_{geom}/_chk/uhf_{mult}_{geom}_newton.chk"
uno_NOs = np.load(f"../gen_uno/_chk/{mult}_{geom}_TZ_100e_100o_eps1=0.0001_vhci_NOs.npy")
uno_mo_occ = np.loadtxt(f"../gen_uno/_data/{mult}_{geom}_TZ_100e_100o_eps1=0.0001_vhci_noons.txt")
# fmt: on
