...
if __name__ == "__main__":
    ...
    # Final frontier orbital figs
    make_figure_for_species("final/1_A", "HCISCF_NOs_1_A.png", "_figures/final")
    make_figure_for_species("final/1_B", "HCISCF_NOs_1_B.png", "_figures/final")
    make_figure_for_species("final/1_C", "HCISCF_NOs_1_C.png", "_figures/final")
    make_figure_for_species("final/3_A", "HCISCF_NOs_3_A.png", "_figures/final")
    make_figure_for_species("final/3_B", "HCISCF_NOs_3_B.png", "_figures/final")
    make_figure_for_species("final/3_C", "HCISCF_NOs_3_C.png", "_figures/final")
