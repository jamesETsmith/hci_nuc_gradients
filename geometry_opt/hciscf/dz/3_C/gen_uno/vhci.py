...
outputbase = f"3_C_DZ_{nelecas}e_{ncas}o_eps1={eps1}_vhci"
uhf_outputbase = "../../../uhf_survey/FN_DIIS/3_C/_chk/uhf_3_C_newton"
...
# vHCI Calculation
#
mc = mcscf.CASCI(mf, ncas, (nelecas // 2 + 1, nelecas // 2 - 1)).density_fit()
