...
for eps1 in [1e-3, 5e-4]:
    ...
    plt.tight_layout()
    plt.savefig(f"_figs/stilbene_single_point_error_{eps1:.1e}.png", dpi=600)
    plt.savefig(f"_figs/stilbene_single_point_error_{eps1:.1e}.pdf")
    plt.close()
